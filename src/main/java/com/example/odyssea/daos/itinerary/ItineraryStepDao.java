...
public class ItineraryStepDao {
    ...
    public List<DailyPlanDto> findByItineraryId(int itineraryId){
        String sql = "SELECT city.name AS cityName, country.name AS countryName, hotel.name AS hotelName, hotel.description AS hotelDescription, activity.name AS activityName, activity_description AS activityDescription, daily_itinerary.description_per_day, daily_itinerary.day_number FROM daily_itinerary\n" +
